...
ALTER TABLE complaints_archive 
  DROP INDEX IF EXISTS uq_complaint_code,
...
CREATE INDEX IF NOT EXISTS idx_comp_archive_created ON complaints_archive(created_at);
CREATE INDEX IF NOT EXISTS idx_comp_archive_status ON complaints_archive(status);
CREATE INDEX IF NOT EXISTS idx_notif_archive_compid ON notifications_archive(complaint_id);
